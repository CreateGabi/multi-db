...
public class BbsUI4 {
	...
	public static void main(String[] args) {
		...
		btnNewButton.setBounds(12, 436, 155, 44);
		...
		btnNewButton_1.setBounds(179, 436, 148, 44);
		f.getContentPane().add(btnNewButton_1);
		
		JButton btnNewButton_1_1_1 = new JButton("검색");
		btnNewButton_1_1_1.setForeground(Color.RED);
		btnNewButton_1_1_1.setFont(new Font("굴림", Font.BOLD, 23));
		btnNewButton_1_1_1.setBackground(Color.ORANGE);
		btnNewButton_1_1_1.setBounds(339, 436, 148, 44);
		...
		btnNewButton_1_1.setBounds(12, 489, 475, 44);
